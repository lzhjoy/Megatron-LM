        ...
        for name, param in named_parameters:
            ...
            if muon_flag:
                ...
                if (
                    ...
                    # NOTE: Muon + FSDP not checked. Simply follow https://github.com/NVIDIA/Megatron-LM/commit/31e8578958dad40e4207b340466da1acf675a132
                    muon_params_map[key].append(param_shard)
                else:
